    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="fixed top-0 right-0 h-full w-64 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 p-6 shadow-xl" style={{ backgroundColor: 'var(--background)', opacity: 1 }}>
