    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] md:hidden">
          ...
          <div className="absolute top-0 right-0 h-full w-64 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-xl z-[101] overflow-y-auto">
