  ...
  return (
    <nav className="flex items-center justify-between p-6 bg-background">
      <div className="flex items-center space-x-3">
        ...
        <LanguageAwareLink to="/" className="text-2xl font-bold text-foreground tracking-tight">
          AmplifiX
        </LanguageAwareLink>
      </div>

      <div className="hidden md:flex items-center space-x-8">
        <LanguageAwareLink to="/about" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors translate">
          About
        </LanguageAwareLink>
        <LanguageAwareLink to="/solutions" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors translate">
          Solutions
        </LanguageAwareLink>
        <LanguageAwareLink to="/showcase" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors translate">
          Showcase
        </LanguageAwareLink>
        <LanguageAwareLink to="/intel" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors translate">
          Intel
        </LanguageAwareLink>
        <LanguageAwareLink to="/faq" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors translate">
          FAQ
        </LanguageAwareLink>
        <LanguageAwareLink to="/contact" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors translate">
          Contact
        </LanguageAwareLink>
      </div>
      ...
      <div className="flex items-center space-x-4">
        {showBackButton && (
          <LanguageAwareLink to={backButtonHref} className="hidden sm:block">
            <Button variant="outline" size="sm" className="translate">
              {backButtonText}
            </Button>
          </LanguageAwareLink>
        )}
