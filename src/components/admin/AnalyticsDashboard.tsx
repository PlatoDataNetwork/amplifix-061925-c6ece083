    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="realtime" className="space-y-6">
        ...
        <TabsContent value="historical" className="space-y-6">
          ...
          <Card><CardHeader className="pb-3"><CardTitle className="text-base flex items-center gap-2"><Eye className="w-4 h-4" />Page Views & Events</CardTitle></CardHeader><CardContent>
