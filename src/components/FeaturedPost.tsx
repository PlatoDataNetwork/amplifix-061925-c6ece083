...
const FeaturedPost = () => {
  return (
    <section className="mb-16">
      <div className="bg-gradient-to-r from-[#06B6D4]/10 to-[#06B6D4]/10 p-8 rounded-2xl border border-[#06B6D4]/20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <div className="flex items-center gap-4 mb-4">
              <span className="bg-[#06B6D4] text-white px-3 py-1 rounded-full text-sm">Featured</span>
            ...
            <Button className="bg-gradient-to-r from-[#06B6D4] to-[#06B6D4] text-xs md:text-sm" asChild>
          ...
          <div className="bg-[#121218] p-8 rounded-xl border border-gray-800 h-64 flex items-center justify-center">
            <Shield className="h-24 w-24 text-[#06B6D4]" />
          </div>
        </div>
      </div>
    </section>
