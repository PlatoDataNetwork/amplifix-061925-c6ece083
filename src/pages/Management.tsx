...
const Management = () => {
  ...
  const renderContent = () => {
    switch (currentView) {
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <Card className="bg-card border-border">
                ...
                <CardContent className="grid grid-cols-2 gap-3">
                  <Button variant="outline" className="justify-start gap-2 h-auto py-3" onClick={() => setCurrentView("new-article")}>
                    <Plus className="w-4 h-4 text-primary" />
                    New Article
                  </Button>
                  <Button variant="outline" className="justify-start gap-2 h-auto py-3" onClick={() => setCurrentView("new-feed")}>
                    <Rss className="w-4 h-4 text-primary" />
                    Add Feed
                  </Button>
                  <Button variant="outline" className="justify-start gap-2 h-auto py-3" onClick={() => setCurrentView("analytics")}>
                    <BarChart3 className="w-4 h-4 text-primary" />
                    Analytics
                  </Button>
                  <Button variant="outline" className="justify-start gap-2 h-auto py-3" onClick={() => handleViewChange("settings-general")}>
      ...
      case "new-article":
        return <ArticleEditor onBack={() => setCurrentView("articles")} />;
      case "tags":
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Admin Management | AmplifiX</title>
