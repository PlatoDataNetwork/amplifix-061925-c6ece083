    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="container mx-auto py-16 px-4 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-card p-8 rounded-xl border border-border text-center">
              <Award className="h-12 w-12 text-highlight-blue mx-auto mb-4" />
      ...
      <section className="container mx-auto py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose AmplifiX</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              <CheckCircle className="h-6 w-6 text-highlight-blue mt-1 flex-shrink-0" />
              <div>
                <h3 className="text-lg font-bold mb-2">Comprehensive IR Solutions</h3>
                <p className="text-muted-foreground">
