  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-24 container mx-auto py-20 px-4">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-6">
            {data.public_companies.hero.title} <span className="text-highlight-blue">{data.public_companies.hero.title_highlight}</span>
          </h1>
      ...
      <section className="container mx-auto py-16 px-4">
        <h2 className="text-3xl font-bold text-center mb-12">{data.public_companies.key_features.title}</h2>
