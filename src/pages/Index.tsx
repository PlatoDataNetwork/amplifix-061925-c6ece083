  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col">
      ...
      <div className="container mx-auto py-20">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-block mb-8">
            <div className="bg-gradient-to-r from-[#7C3AED]/10 to-[#3B82F6]/10 text-[#7C3AED] rounded-full px-6 py-2 border border-[#7C3AED]/20">
      ...
      <div className="container mx-auto py-16">
        <div className="bg-[#121218] rounded-2xl p-8 border border-gray-800 shadow-2xl">
      ...
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#121218] p-6 rounded-xl border border-gray-800">
            <div className="mb-4 w-12 h-12 rounded-lg bg-[#7C3AED]/20 flex items-center justify-center">
              <LockKeyhole className="h-6 w-6 text-[#7C3AED]" />
            </div>
            ...
            <Button variant="link" className="text-[#7C3AED] mt-4 p-0">
              Learn more →
            </Button>
          </div>
      ...
      <div className="container mx-auto py-16">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          <div className="md:w-1/2">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <div className="w-5 h-5 rounded-full bg-[#7C3AED] flex items-center justify-center mr-3">
          ...
          <div className="md:w-1/2 relative">
            <div className="w-64 h-64 bg-gradient-to-r from-[#7C3AED] to-[#06B6D4] rounded-full blur-3xl opacity-30 absolute -z-10 transform -translate-x-1/2 -translate-y-1/2"></div>
            <div className="w-64 h-64 rounded-full border-4 border-[#7C3AED]/30 p-3">
              <div className="w-full h-full rounded-full border-4 border-[#06B6D4]/30 p-3">
                <div className="w-full h-full rounded-full bg-gradient-to-r from-[#7C3AED]/40 to-[#06B6D4]/40 flex items-center justify-center">
