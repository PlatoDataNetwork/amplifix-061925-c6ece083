 ...
 * - Minimal spacing between paragraphs (mb-0)
 * - Large, bold section headers (h2: text-4xl, h3: text-2xl)
 * - Minimal margins on headers (mt-1, mb-0)
 * - Tight list spacing (my-1, space-y-1)
 */
export const ARTICLE_CONTENT_CLASSES = "text-foreground leading-relaxed whitespace-pre-wrap [&>p]:mb-0 [&>p]:leading-relaxed [&>h2]:mt-1 [&>h2]:mb-0 [&>h2]:text-4xl [&>h2]:font-bold [&>h2]:leading-tight [&>h3]:mt-1 [&>h3]:mb-0 [&>h3]:text-2xl [&>h3]:font-bold [&>strong]:mt-1 [&>strong]:mb-0 [&>strong]:block [&>ul]:my-1 [&>ul]:space-y-1 [&>ol]:my-1 [&>ol]:space-y-1";
